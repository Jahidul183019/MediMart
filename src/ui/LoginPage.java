...
public class LoginPage {
    ...
    private void setupBackgroundImage() {
        try {
            ...
            if (url != null) {
                ...
                System.err.println("⚠️ LoginPage: /images/home_background.png NOT found on classpath. Using fallback path.");
    ...
    private void login() {
        ...
        final String pass  = (passwordField != null && passwordField.getText() != null)
