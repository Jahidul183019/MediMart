...
public class SignupForm {
    ...
    public VBox getRoot() {
        ...
        signupBtn.setOnAction(e -> signup(firstNameField, lastNameField, emailField, passwordField, confirmPasswordField, phoneField));
        backBtn.setOnAction(e -> goBack());

        // === BIGGER inner "card" (inside layer) ===
        VBox card = new VBox(
                8,  // space between title and subtitle
                titleLabel,
                subtitle,
                new Separator(),
                firstNameField,
    ...
    private void signup(TextField firstNameField, TextField lastNameField, TextField emailField, PasswordField passwordField, PasswordField confirmPasswordField, TextField phoneField) {
